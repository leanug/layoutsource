...
export function SearchBar() {
  ...
  return (
    <div className="relative w-full">
      <MagnifyingGlassSolid className="w-5 h-5 fill-gray-500 dark:fill-gray-300 absolute left-5 top-1/2 transform -translate-y-1/2  text-gray-400" />
      <input
        id="search-layouts"
        className={`
          ...
          dark:focus:border-purple-100 bg-gray-50 dark:bg-gray-700 dark:border-gray-700
