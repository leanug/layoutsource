    ...
    <div className="flex justify-center">
      <div className="inline-block">
        ...
        {designCategories.map((cat) => (
          <span
            key={cat.id}
            className="mr-2 mb-2 inline-block bg-gray-300 rounded-full py-1 px-3 text-sm font-semibold text-gray-700"
          >
        ...
        <p>
          <a href={design.link} className="text-blue-500 hover:underline">
            {design.link}
          </a>
        </p>
        ...
        <p className="mt-4">
          {fonts.map((font, index) => (
            <span
              key={index}
              className="mr-2 bg-gray-300 rounded-full py-1 px-3 text-sm font-semibold text-gray-700"
            >
              {font}
            </span>
          ))}
